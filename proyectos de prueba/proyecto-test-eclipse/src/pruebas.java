...
public class pruebas {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JTextField entryNuevoUsuario = new JTextField(30);
        JPasswordField entryNuevaContra = new JPasswordField(30);


        JLabel labelUsuario = new JLabel("Usuario");
        JLabel labelContra = new JLabel("Contraseña");
        JTextField entryUsuario = new JTextField(30);
        JPasswordField entryContra = new JPasswordField(30);


        JButton registrar = new JButton("Registrarse");
        JButton entrar = new JButton("Entrar");

        JLabel resultado = new JLabel("Registro: Sin información aún");
        JLabel resultado2 = new JLabel("Entrada: Sin información aún");
